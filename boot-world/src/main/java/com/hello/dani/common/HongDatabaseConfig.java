...
@MapperScan(value="com.hello.dani.dao2", sqlSessionFactoryRef="db2SqlSessionFactory")
public class HongDatabaseConfig {
	...
	public SqlSessionFactory db2SqlSessionFactory(@Qualifier("db2DataSource") DataSource db2DataSource,
		...
		sqlSessionFactoryBean.setMapperLocations(applicationContext.getResources("classpath:mappers/HONG/*Mapper.xml"));
